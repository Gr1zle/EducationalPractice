...
const fortniteItems = [
  ...
  },
  {
    ...
    name: "Набор 'Айконик'",
    price: 10000,
    image: "https://avatars.mds.yandex.net/i?id=2ac3b1242d369a28ac0ab34ea9d87bcf_l-5084109-images-thumbs&n=13"
  },
  {
    id: 6,
    name: "Джем-трек 'd4vd'",
  ...
  return (
    <div className="main-content">
      <header className="page-header">
        ...
        <p>Выберите понравившиеся предметы</p>
      </header>
      
      <div className="products-grid">
        {fortniteItems.map(product => (
